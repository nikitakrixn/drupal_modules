...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.modal_form = {
    attach: function (context, settings) {
      var modal = Drupal.dialog('{{ parent() }}',{
        width: drupalSettings.statusMessage.modalWindow.width,
        height: drupalSettings.statusMessage.modalWindow.height,
        background: drupalSettings.statusMessage.modalWindow.background,
        create: function () {
          $(this).parent().find('.messages__wrapper .layout-container').remove();
        },
      });
