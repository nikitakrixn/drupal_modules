...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.modal_form = {
    attach: function (context, settings) {
      var modal_settings = settings.modal_form;
      var modal = Drupal.dialog('#modal_window',{
        title: 'Status Message',
        minWidth: modal_settings.statusMessage.modalWindow.width,
        minHeight: modal_settings.statusMessage.modalWindow.height,
