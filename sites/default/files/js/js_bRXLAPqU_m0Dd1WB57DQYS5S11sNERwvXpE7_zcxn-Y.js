...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.modal_form = {
    attach: function (context, settings) {
      ...
      $('.message-popup-title', message_box).on('mousedown', function (event) {
        isDown = true;
        offset.height = event.clientY - message_box.offset().top;
        offset.width = event.clientY - message_box.offset().left;
        return false;
      });

      $(document).mousemove(function (event) {
        if (isDown){
          var top = event.clientY - offset.height,
              left = event.clientX - offset.width,
              maxTop = this.document.documentElement.clientHeight - message_box.height(),
              maxLeft = this.document.documentElement.clientWidth - message_box.width();
      ...
      $(document).keypress(function (e) {
        if (e.keyCode === 27) {
          $('.message-popup').addClass('is-hidden');
