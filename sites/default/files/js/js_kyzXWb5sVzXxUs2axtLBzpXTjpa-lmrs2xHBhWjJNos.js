...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.modal_form = {
    attach: function (context, settings) {
      ...
      message_box.css('min-width', modalMessage.width + 'px');
      message_box.css('min-height', modalMessage.height + 'px');

      var vertical = ($(window).height() - message_box.height()) / 2;
      var horizontal = ($(window).width() - message_box.width()) / 2;
      var cssPosition = {top: vertical + 'px', left: horizontal + 'px'};
