...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.modal_form = {
    attach: function (context, settings) {
      ...
      $('.message-popup-title').on('mousedown', function (e) {
        isDown = true;
      ...
      $(this.document).mousemove(function(e) {
        if (this.isDown) {
          ...
          var top = event.clientY - $(this).offset.height,
            ...
            maxL = $(this).document.documentElement.clientWidth - message_box.width(),
            maxT = $(this).document.documentElement.clientHeight - message_box.height();
          left = left < 0 ? 0 : left;
          left = left > maxL ? maxL : left;
          top = top < 0 ? 0 : top;
          top = top > maxT ? maxT : top;
         message_box.css("top", top + "px");
